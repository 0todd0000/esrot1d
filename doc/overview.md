...
The [analysis](https://github.com/0todd0000/esrot1d/tree/main/analysis) folder contains data and scripts that were used to generate all results in the manuscript. Please refer to the [reproduce results notebook](reproduce_results.ipynb) for instructions on how to reproduce the paper's results.
